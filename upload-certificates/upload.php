...
if($name!=""  && $regno!="" && $event!="" ){
 $query="insert into certificates (name,regno,event,pic) values ('$name','$regno','$event', '$destifile')";
...
<body>
 ...
 ?>
        ...
        <h1>Certificate successfully uploaded.</h1>
        <a href="https://blackcurrent.club/upload-certificates">
