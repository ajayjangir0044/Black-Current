...
<body>
    <section id="nav1">
        ...
        <div class="elements">
            <ul>
                <li><a class="hover" style="font-size: 14px;" href="https://blackcurrent.club">Home</a></li>
        ...
        <div id="div2">
            <form  action="upload.php" autocomplete="off" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control sub" id="exampleInputEmail1" aria-describedby="emailHelp"
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control sub" id="exampleInputEmail1" aria-describedby="emailHelp"
                        placeholder="Enter your mobile no" name="contact" required>

                </div>
           
                <div class="form-group">
                        <label for="exampleInputEmail1">Choose Query/Feedback</label>
                        <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" name="queryy"
                         required>
                ...
                <div class="form-group">
                    <label for="exampleFormControlTextarea1">Enter your query/feedback</label>
        ...
        <footer>
            <div id="part1">
                <div>
                    ...
                    <a href="https://blackcurrent.club">
                        <p>Home</p>
                    </a>
                    <a href="https://blackcurrent.club">
                        <p>About us</p>
            ...
            <div id="part2">
                    <div>
                        ...
                        <p><a href="tel:+917413882466">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp+91
                                74138 82466</a></p>
                    </div>
                    <div>
